   ...
   <section class="content-header">
      <div class="row mb-2">
         <div class="col-md-auto col-12">
            <h2>Report Penjualan by Payment</h2>
         </div>
         <div class="col align-self-end">
            <ol class="breadcrumb float-md-end">
               <li class="breadcrumb-item">Penjualan</li>
               <li class="breadcrumb-item active">Report Penjualan by Payment</li>
            </ol>
         </div>
      </div>
   </section>
         ...
         <div class="card border-top-orange">
            <div class="card-header">
               <div class="row align-items-center">
                  <div class="col">
                     <span class="fw-bold"><i class="fas fa-shopping-bag" aria-hidden="true"></i>&nbsp;Report - Penjualan by Payment</span>
                  </div>
               </div>
            </div>
            <div class="card-body">
      ...
      $(document).ready(function() {
         ...
         $("#btn-view").click(function() {
            ...
            ajax_req = $.ajax({
               ...
               url: "<?= site_url('function/client_export_sales/sales_payment_load/') ?>",
         ...
         $("#btn-export").click(function() {
            ...
            $.redirect('<?php echo site_url('function/client_export_sales/sales_payment_export') ?>', {
               'datestart': StartDateContent.format('YYYY-MM-DD'),
               'dateend': EndDateContent.format('YYYY-MM-DD'),
               'store': $('#tb_status').val(),
            }, "POST", "_blank");
