   ...
   <section class="content-header">
      <div class="row mb-2">
         <div class="col-md-auto col-12">
            <h2>Data Stock Opname (SO)</h1>
         </div>
         <div class="col align-self-end">
            <ol class="breadcrumb float-md-end">
               <li class="breadcrumb-item">Inventory</li>
               <li class="breadcrumb-item active">Data Stock Opname (SO)</li>
            </ol>
         </div>
      </div>
   </section>
         ...
         <div class="card border-top-orange">
            <div class="card-header">
               <div class="row align-items-center">
                  <div class="col">
                     <span class="fw-bold"><i class="fas fa-warehouse" aria-hidden="true"></i>&nbsp;Inventory - Data Stock Opname (SO)</span>
                  </div>
   ...
   <script>
      $(document).ready(function() {
         ...
         var table = $('#tb_data').DataTable({
            ...
            "serverSide": true,
            "ajax": {
               "url": "<?php echo site_url('function/Client_datatable_inventory/get_data_so') ?>",
               "type": "POST",
               "data": function(data) {
                  ...
                  data.search['coltanggal'] = "InvSODate";
               }
            },
            "order": [],
            "columnDefs": [{
         ...
         async function get_detail_item(code) {
            var res = $.ajax({
               type: "POST",
               url: "<?php echo site_url('function/Client_datatable_inventory/get_detail_so') ?>",
               data: {
                  "code": code
               },
         ...
         $("#btn-add").click(function(e) {
            ...
            if (!req_status) {
               $.ajax({
                  url: "<?php echo site_url('message/message_inventory/stock_opname/') ?>",
                  beforeSend: function() {
                     req_status = 1;
                  },
