   ...
   <section class="content-header">
      <div class="row mb-2">
         <div class="col-md-auto col-12">
            <h2>Data Terima Barang (TI)</h1>
         </div>
         <div class="col align-self-end">
            <ol class="breadcrumb float-md-end">
               <li class="breadcrumb-item">Inventory</li>
               <li class="breadcrumb-item active">Data Terima Barang (TI)</li>
            </ol>
         </div>
      </div>
   </section>
         ...
         <div class="card border-top-orange">
            <div class="card-header">
               <div class="row align-items-center">
                  <div class="col">
                     <span class="fw-bold"><i class="fas fa-warehouse" aria-hidden="true"></i>&nbsp;Inventory - Data Terima Barang (TI)</span>
                  </div>
            ...
            <div class="card-body">
               <div class="row">
                  <div class="col-lg-6 col-12">
                     ...
                     <div class="row mb-1">
                        <label for="tb_store" class="col-sm-3 col-form-label">Dari Toko</label>
                        <div class="col-sm-9">
   ...
   <script>
      $(document).ready(function() {
         ...
         async function get_detail_item(code) {
            var res = $.ajax({
               type: "POST",
               url: "<?php echo site_url('function/Client_datatable_inventory/get_detail_ti') ?>",
               data: {
                  "code": code
               },
         ...
         $("#btn-add-kunjungan").click(function(e) {
            ...
            if (!req_status) {
               $.ajax({
                  url: "<?php echo site_url('message/message_inventory/transfer_in/') ?>",
                  beforeSend: function() {
                     req_status = 1;
                  },
         ...
         edit_click = function(id) {
            if (!req_status) {
               $.ajax({
                  url: "<?php echo site_url('message/message_inventory/transfer_in_edit/') ?>" + id,
                  beforeSend: function() {
                     req_status = 1;
                  },
                  success: function(response) {
         ...
         delete_click = function(id) {
            if (!req_status) {
               ...
               swalWithBootstrapButtons.fire({
                  title: "Hapus data",
                  html: 'Anda yakin ingin menghapus data TI ini ?',
                  icon: "warning",
                  ...
                  if (result.isConfirmed) {
                     $.ajax({
                        method: "POST",
                        url: "<?= site_url("function/client_data_inventory/data_ti_delete/") ?>" + id,
                        before: function() {
                           req_status_add = 1;
                        },
                        success: function(data) {
         ...
         print_click = function(po_id) {
            window.open('<?php echo site_url('export/inventory/ti/') ?>' + po_id, '_blank');
         }
