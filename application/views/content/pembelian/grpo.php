   ...
   <section class="content-header">
      <div class="row mb-2">
         <div class="col-md-auto col-12">
            <h2 onclick="menuselect('pembelian-grpovendor','menu-pembelian')">Data Good Receipt PO (GRPO)</h1>
         </div>
         <div class="col align-self-end">
            <ol class="breadcrumb float-md-end">
               <li class="breadcrumb-item">Pembelian</li>
               <li class="breadcrumb-item active" onclick="menuselect('pembelian-grpovendor','menu-pembelian')">Data Good Receipt PO (GRPO)</li>
            </ol>
         </div>
      </div>
   </section>
         ...
         <div class="card border-top-orange">
            <div class="card-header">
               <div class="row align-items-center">
                  <div class="col">
                     <span class="fw-bold"><i class="fas fa-luggage-cart" aria-hidden="true"></i>&nbsp;Pembelian - Data Good Receipt PO (GRPO)</span>
                  </div>
