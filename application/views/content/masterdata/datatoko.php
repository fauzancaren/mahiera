...
<body style="font-family: 'Noto Sans', sans-serif;color:#352f2a;">
            ...
            <div class="card border-top-orange">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <span class="fw-bold"><i class="fas fa-database" aria-hidden="true"></i>&nbsp;Master Data - Data Toko</span>
                        </div>
                        <div class="col-auto px-1">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" onclick="window.open('<?php echo site_url('function/client_export_master/data_toko_export_excel')?>','_blank')"><small><i class="fas fa-file-excel"></i>&nbsp;Export Excel</small></a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" onclick="window.open('<?php echo site_url('export/datamaster/toko')?>','_blank')"><small><i class="fas fa-file-pdf"></i>&nbsp;Export PDF</small></a></li>
                            </ul>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="row mb-1">
                                <label for="tb_row" class="col-sm-3 col-form-label">Status Toko</label>
                                <div class="col-sm-9">
                    ...
                    <div class="table-responsive" id="tb_data_respon" >
                        <table id="tb_data" class="table table-hover align-middle"  style="font-family: 'Noto Sans', sans-serif; font-size:80%;width:100%">
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#tb_data').DataTable( {
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?php echo site_url('function/client_datatable/get_master_toko')?>",
                    "type": "POST",
                    "data": function(data){
                        data.search['value'] = $('#tb_search').val();
                        data.search['status'] = $('#tb_status').val();
                        data.search['colstatus'] = "MsWorkplaceIsActive";
                    }
                },
                "order": [],
                "columnDefs": [
            ...
            $('#btn-add-master').click(function (e) { 
                ...
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_toko_add/')?>",
                        beforeSend: function(){
                            req_status = 1;
                        },
            ...
            view_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_toko_view/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            edit_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_toko_edit/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            delete_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_toko_delete/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            enable_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_toko_enable/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
