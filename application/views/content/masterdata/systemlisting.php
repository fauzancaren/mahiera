        ...
        <div class="row mb-2">
            ...
            <div class="col-md-6 align-self-end">
                <ol class="breadcrumb float-md-end">
                    ...
                    <li class="breadcrumb-item active">Menu Listing</li>
                </ol>
            </div>
        </div>
    </section> 
            ...
            <div class="card border-top-orange">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <span class="fw-bold"><i class="fas fa-database" aria-hidden="true"></i>&nbsp;Master Data - Menu Listing</span>
                        </div>
                         
                        <div class="col-auto px-0"> 
                            <button onclick="add_click()" class="btn btn-success btn-sm btn-hide">
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#tb_data').DataTable( {
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?php echo site_url('function/client_datatable/get_master_menu_listing')?>",
                    "type": "POST",
                    "data": function(data){
            ...
            add_click = function(){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_system_listing_add/')?>",
                        beforeSend: function(){
                            req_status = 1;
                        },
            ...
            edit_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_system_listing_edit/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
