            ...
            <div class="card border-top-orange">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <span class="fw-bold"><i class="fas fa-database" aria-hidden="true"></i>&nbsp;Master Data - Data Vendor</span>
                        </div>
                        <div class="col-auto px-1">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" onclick="window.open('<?php echo site_url('function/client_export_master/data_vendor_export_excel')?>','_blank')">
                                        <small><i class="fas fa-file-excel"></i>&nbsp;Export Excel</small>
                                    </a>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <a class="dropdown-item" onclick="window.open('<?php echo site_url('export/datamaster/vendor')?>','_blank')">
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#tb_data').DataTable( {
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?php echo site_url('function/client_datatable/get_master_vendor')?>",
                    "type": "POST",
                    "data": function(data){
                        data.search['value'] = $('#tb_search').val();
                        data.search['status'] = $('#tb_status').val();
                        data.search['colstatus'] = "MsVendorIsActive";
                    }
                },
                "order": [],
                "columnDefs": [
            ...
            $('#btn-add-master').click(function (e) { 
                ...
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_vendor_add/')?>",
                        beforeSend: function(){
                            req_status = 1;
                        },
            ...
            view_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_vendor_view/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            edit_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_vendor_edit/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            delete_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_vendor_delete/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            enable_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_vendor_enable/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
