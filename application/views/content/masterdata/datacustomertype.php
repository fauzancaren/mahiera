...
<body>
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-md-6">
                <h2>Data Tipe Pelanggan</h2>
            </div>
            <div class="col-md-6 align-self-end">
                <ol class="breadcrumb float-md-end">
                    <li class="breadcrumb-item">Master Data</li>
                    <li class="breadcrumb-item active">Data Tipe Pelanggan</li>
                </ol>
            </div>
        </div>
    </section> 
            ...
            <div class="card border-top-orange">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <span class="float-start p-2 fw-bold"><i class="fas fa-database" aria-hidden="true"></i>&nbsp;Master Data - Data Tipe Pelanggan</span>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#tb_data').DataTable( { 
                ...
                "serverSide": true,
                "ajax": {
                    "url": "<?php echo site_url('function/client_datatable/get_master_customer_type')?>",
                    "type": "POST",
                    "data": function(data){
                        data.search['value'] = $('#tb_search').val();
                        data.search['status'] = $('#tb_status').val();
                        data.search['colstatus'] = "MsCustomerTypeIsActive";
                    }
                },
                "order": [],
                "columnDefs": [
            ...
            $('#btn-add-master').click(function (e) { 
                ...
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_customer_type_add/')?>",
                        beforeSend: function(){
                            req_status = 1;
                        },
            ...
            view_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_customer_type_view/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            edit_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_customer_type_edit/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            delete_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_customer_type_delete/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
            ...
            enable_click = function(id){
                if(!req_status){     
                    $.ajax({
                        url:  "<?php echo site_url('message/message_master/data_customer_type_enable/')?>" + id,
                        beforeSend: function(){
                            req_status = 1;
                        },
                        success: function (response) {
