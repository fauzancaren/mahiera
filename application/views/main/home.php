        ...
        <div class="ltn__slider-area ltn__slider-3  section-bg-2---">
            <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1">
                <!-- ltn__slide-item -->
                <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-60---" data-bg="<?= base_url() ?>asset/image/mgs-erp/slide/slide.png">
                    <div class="ltn__slide-item-inner text-left">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 align-self-center "> 
                                    <img class="image-slide" src="<?= base_url()?>asset/image/mgs-erp/slide/2.png" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-60---" data-bg="<?= base_url() ?>asset/image/mgs-erp/slide/slide.png">
                    <div class="ltn__slide-item-inner  text-right text-end">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 align-self-center "> 
                                    <img class="image-slide" src="<?= base_url()?>asset/image/mgs-erp/slide/1.png" alt="Image">
                                </div>
                                <div class="col-lg-6 align-self-center">
                                    <div class="slide-item-info">
                                        <div class="slide-item-info-inner ltn__slide-animation">
                    ...
                    <div class="ltn__slide-item-inner text-left">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 align-self-center "> 
                                    <img class="image-slide" src="<?= base_url()?>asset/image/mgs-erp/slide/3.png" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
                 ...
                 <div class="ltn__slide-item ltn__slide-item-2  ltn__slide-item-3-normal--- ltn__slide-item-3 bg-image bg-overlay-theme-black-60---" data-bg="<?= base_url() ?>asset/image/mgs-erp/slide/slide.png">
                    <div class="ltn__slide-item-inner text-right text-end">
                        <div class="container">
                            <div class="row"> 
                                <div class="col-lg-6 align-self-center "> 
                                    <img class="image-slide" src="<?= base_url()?>asset/image/mgs-erp/slide/4.png" alt="Image">
                                </div>
                                <div class="col-lg-6 align-self-center">
                                    <div class="slide-item-info">
                                        <div class="slide-item-info-inner ltn__slide-animation">
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div class="about-us-img-wrap about-img-left">
                            <img src="<?= base_url() ?>asset/image/mgs-erp/pro-user.png" alt="About Us Image">
                        </div>
                    </div>
                    <div class="col-lg-6 align-self-center">
        ...
        <div class="ltn__feature-area bg-image-top pt-120 pb-35---" data-bg="<?= base_url()?>asset/image/mgs-erp/background/32.jpg">
            <div class="container">
        ...
        <!-- Services AREA START -->
        <div class="ltn__about-us-area section-bg-1 bg-image pt-120 pb-90" data-bg="<?= base_url()?>asset/image/mgs-erp/background/31.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 align-self-center">
            ...
            <div class="container">
                ...
                <div class="row ltn__image-slider-3-active slick-arrow-1 slick-arrow-1-inner---"> 
                    <div class="col-lg-12">
                        <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                            <a href="portfolio-details.html">
                                <img src="<?= base_url() ?>asset/image/mgs-erp/project/project6.png" alt="Image">
                            </a>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                            <a href="portfolio-details.html">
                                <img src="<?= base_url() ?>asset/image/mgs-erp/project/project1.png" alt="Image">
                            </a>
                            <div class="ltn__img-slide-info">
                                <div class="ltn__img-slide-info-brief">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                            <a href="portfolio-details.html">
                                <img src="<?= base_url() ?>asset/image/mgs-erp/project/project2.png" alt="Image">
                            </a>
                            <div class="ltn__img-slide-info">
                                <div class="ltn__img-slide-info-brief">
                                    <h6>JASA RENOVASI RUMAH</h6>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                            <a href="portfolio-details.html">
                                <img src="<?= base_url() ?>asset/image/mgs-erp/project/project3.png" alt="Image">
                            </a>
                            <div class="ltn__img-slide-info">
                                <div class="ltn__img-slide-info-brief">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                            <a href="portfolio-details.html">
                                <img src="<?= base_url() ?>asset/image/mgs-erp/project/project4.png" alt="Image">
                            </a>
                            <div class="ltn__img-slide-info">
                                <div class="ltn__img-slide-info-brief">
                                    <h6>JASA INTERIOR & EXTERIOR</h6>
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                            <a href="portfolio-details.html">
                                <img src="<?= base_url() ?>asset/image/mgs-erp/project/project5.png" alt="Image">
                            </a>
                            <div class="ltn__img-slide-info">
                                <div class="ltn__img-slide-info-brief">
                                    <h6>JASA PASANG BATA EXPOSE & BATA TEMPEL</h6>
