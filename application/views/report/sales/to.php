   ...
   <div class="item">
      <table class="center" style="width: 100%;border-collapse: collapse;border-bottom: 1px solid black;margin-right:20px">
         ...
         foreach ($_item as $rowsitem) { 
            $data_split_var =  explode("|",$rowsitem->InvTODetailVarian);
            $varian = "";
            ...
            $data .=      '
               <tr style="font-size:13px;vertical-align: top;" >
                  ...
                  <td style="width:30px;padding-right:5px;font-size:13px;text-align: right;">' . number_format($rowsitem->InvTODetailQty, 2) . '</td>
