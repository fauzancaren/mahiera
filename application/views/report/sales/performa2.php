         ...
         <tr>
            ...
            <td align="left" valign="top" style="width:30%;font-size:13px">
               <table style="width: 100%;margin-right:13px;margin-top:0px;border-collapse: collapse;">
                  <tr>
                     <td align="right" valign="top" style="width:47%;font-size:13px;">DP 30%</td>
                     <td align="right" valign="top" style="width:50%;font-size:13px;font-weight:bold">11,027,250</td>
                  </tr>
                  <tr>
                     <td align="right" valign="top" style="width:47%;font-size:13px;">PPN</td>
                     <td align="right" valign="top" style="width:50%;font-size:13px;font-weight:bold">0</td>
                  </tr>
               </table>
               <hr style="margin:1px">
               </hr>
               <table style="width: 100%;margin-right:13px;margin-top:0px;border-collapse: collapse; ">
                  <tr>
                     <td align="right" valign="top" style="width:47%;font-size:13px;font-weight:bold">Total</td>
                     <td align="right" valign="top" style="width:50%;font-size:13px;font-weight:bold">11,027,250</td>
                  </tr>
               </table>
            </td>
