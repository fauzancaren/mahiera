...
<body>
   ...
   <table style="width: 100%;margin-top:0px">
      <tr>
         <td align="left" valign="top" style="width:28%;font-size:13px">
            <table style="width: 100%;margin-top:0px">
               <tr>
         ...
         <td align="left" valign="top" style="width:42%;font-size:11px">
            Note :
            <ol>
               <?= $_footer ?>
            </ol>
         ...
         <td align="left" valign="top" style="width:30%;font-size:13px">
            <table style="width: 100%;margin-right:7px;margin-top:0px;border-collapse: collapse;">
               <tr>
            ...
            <hr style="margin:1px;margin-right:8px" />
            <table style="width: 100%;margin-right:8px;margin-top:0px;border-collapse: collapse;">';
               <?php
               ...
               foreach ($_payment as $row) {
                  echo '
               <tr>
                  <td align="left" valign="top" style="width:70%;font-size:13px;">' . $row->MsMethodName . ' (' . $row->PerformaDate . ')</td>
