...
<head>
   ...
   <title>PO - <?= ($_data->MsCustomerTypeId == 1 ? $_data->MsCustomerName : $_data->MsCustomerName . ' (' . $_data->MsCustomerCompany . ')') ?> </title>
   <style>
      @font-face {
   ...
   <div class="content">
      <table style="width: 100%;margin-top:0px;border-collapse: collapse;">
         ...
         <tr>
            ...
            <td align="left" valign="top" style="width:2%;font-size:14px;">:</td>
            <td align="left" valign="top" style="width:73%;font-size:14px;"><?= $_data->MsVendorCode . " - " . $_data->MsVendorName ?></td>
         </tr>
      </table>
      <table class="center border" style="width: 100%;padding:5px;border-collapse: collapse;border: 1px solid black;">
         <tr>
         ...
         foreach ($_item as $rowsitem) {
            ...
            <tr style="font-size:13px;vertical-align: center;" >
               ...
               <td>
                  <span style="font-size:13px;">' . $rowsitem->MsProdukCode . '-' . $rowsitem->MsProdukName . '<span><br>
                  <span style="font-size:12px;">' . $rowsitem->PODetailVarian . '<span>
               </td>
