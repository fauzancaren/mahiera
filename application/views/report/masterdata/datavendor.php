...
<head>
    ...
    <title>DATA MASTER - DATA VENDOR</title>
    <style>
        .css_table,
        .css_th,
        .css_td {
...
<body>
    ...
    <table class="css_table" style="width:100%">
        ...
        foreach ($datatable as $key) {
            ...
            echo '  <td class="css_td">' . $key->MsVendorCode . '</td>  ';
            echo '  <td class="css_td">' . $key->MsVendorName . '</td>  ';
            echo '  <td class="css_td">' . ($key->MsVendorIsActive == 1 ? "Aktif" : "Tidak Aktif") . '</td>  ';
            echo '</tr>                                 ';
            $no++;
        }
        ?>
