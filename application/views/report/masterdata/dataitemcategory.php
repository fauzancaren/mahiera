...
<head>
    ...
    <title>DATA MASTER - DATA ITEM CATEGORY</title>
    <style>
        .css_table,
        .css_th,
        .css_td {
...
<body>
    ...
    <table class="css_table" style="width:100%">
        ...
        foreach ($datatable as $key) {
            ...
            echo '  <td class="css_td">' . $key->MsItemCatCode . '</td>  ';
            echo '  <td class="css_td">' . $key->MsItemCatName . '</td>  ';
            echo '  <td class="css_td">' . ($key->MsItemCatIsActive == 1 ? "Aktif" : "Tidak Aktif") . '</td>  ';
            echo '</tr>                                 ';
            $no++;
        }
        ?>
