...
<body>
   <header>
      <img src="./asset/image/mgs-erp/Header.png" style="width: 100%;">
      <img class="logo" src="./asset/image/logo/logo-1-200.png" width="140px">
      <div class="title">
   ...
   <main style="top:200px;padding:0.5rem">
      ...
      <table class="center" style="border-collapse: collapse;border-bottom: 1px solid black;width:95%">
         <tr>
            ...
            <th style="text-align: right;">Disc per item</th>
         ...
         foreach ($_item as $row) {
            ...
            $item .= "   <td>" . $row->MsItemCode . " - " . $row->MsItemName . "<br>Rp. " . number_format($row->QuoDetailPrice) . " /" . $row->MsItemUoM . "</td>";
            $item .= "   <td>" . $row->MsItemSize . "</td>";
            $item .= "   <td style='text-align: right;'>" . number_format($row->QuoDetailQty) . " " . $row->MsItemUoM . "</td>";
            $item .= "   <td style='text-align: right;'>" . ($row->QuoDetailDisc == 0 ? "-" :  "Rp. " . number_format($row->QuoDetailDisc)) . "</td>";
            $item .= "   <td style='text-align: right;'>Rp. " . number_format($row->QuoDetailTotal) . "</td>";
            $item .= "</tr>";
            $no++;
         }
         if (strlen($item) == 0) {
            $item = "<trstyle='font-size:12px;vertical-align: top;'><td colspan='6'>Tidak Ada Data</td></trstyle=>";
         }
         echo $item;
         ...
         foreach ($_optional as $row) {
            ...
            $optional .= "   <td colspan='4'>" . $row->QuoOptionalDesc . "</td>";
      ...
      <div style="margin-left:50px;font-size:14px;margin-top:25px">
         <span>Disiapkan Oleh : <b>Admin</b></span><br>
