   ...
   <div class="modal-dialog modal-xl">
      <div class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-pencil-alt text-warning" aria-hidden="true"></i> &nbsp;pengiriman</h6>
            ...
            <div class="row justify-content-center">
               <div class="col-lg-6 col-11 my-1">
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-9">
                        <input id="DeliveryRef" name="DeliveryRef" type="text" class="form-control form-control-sm" value="<?= $_delivery->DeliveryRef ?>" readonly>
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
                     <div class="label-border-right">
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-4">
                        <input id="DeliveryAdmin" name="DeliveryAdmin" type="text" class="form-control form-control-sm" value="<?= $_delivery->MsEmpName ?>" readonly>
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
...
<script>
   ...
   var data_po = <?= JSON_ENCODE($_podetail) ?>;

   function get_sum_po(itemid, vendor) {
      var total = 0;
      for (var i = 0; data_po.length > i; i++) {
         if (itemid == data_po[i]['MsItemId'] && vendor == data_po[i]['MsVendorCode']) {
   ...
   for (var i = 0; data_item_edit.length > i; i++) {
      ...
      var total_sales = get_sum_po(data_item_edit[i]['MsItemId'], data_item_edit[i]['MsVendorCode']);
      var htmlItem = '<div class="row row-table get-item">';
      htmlItem += '     <div class="col-lg-5 col-12 mb-lg-0 mb-2" >';
