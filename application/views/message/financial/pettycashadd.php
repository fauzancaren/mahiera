   ...
   <div class="modal-dialog modal-lg">
      <form class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-plus text-success" aria-hidden="true"></i> &nbsp;Petty Cash</h6>
         ...
         <div class="modal-body">
            <div class="row mb-1 align-items-center">
               ...
               <div class="col-sm-9">
                  <select class="custom-select custom-select-sm form-control form-control-sm select-modal" id="MsWorkplaceId" name="MsWorkplaceId" style="width:100%">
                     ...
                     foreach ($db as $key) {
                        echo '<option value="' . $key->MsWorkplaceId . '" data-template="' . $key->MsWorkplaceTemplate . '" ' . ($_workplace == $key->MsWorkplaceId ? "selected" : "") . '>' . $key->MsWorkplaceCode . '</option>';
                     }
                     ?>
                  </select>
               </div>
            ...
            <div class="row mb-1 align-items-center">
               ...
               <div class="col-sm-9">
                  <textarea id="FinancialDesc" name="FinancialDesc" type="text" class="form-control form-control-sm" value="" placeholder="Masukan keterangan"></textarea>
               </div>
            </div>
            <div class="row mb-1 align-items-center">
               <label for="FinancialTotal" class="col-sm-3 col-form-label">Total</label>
               <div class="col-sm-9">
                  <input id="FinancialTotal" name="FinancialTotal" type="text" class="form-control form-control-sm price-modal" value="" placeholder="Masukan Total">
               </div>
            </div>
            <div class="row mb-1 align-items-center">
            </div>
...
<script>
   ...
   //    myDropzone.options.url = "<?= site_url("function/client_data_sales/customer_upload_file/") ?> + path_folder;
