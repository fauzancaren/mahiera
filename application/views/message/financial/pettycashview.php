   ...
   <div class="modal-dialog modal-lg">
      <form class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-eye text-info" aria-hidden="true"></i> &nbsp;Petty Cash</h6>
         ...
         <div class="modal-body">
            <div class="row mb-1 align-items-center">
               ...
               <div class="col-sm-9">
                  ...
                  foreach ($db as $key) {
                     if ($_finance->MsWorkplaceId == $key->MsWorkplaceId)
                        echo '<input id="MsWorkplaceId" name="MsWorkplaceId" type="text" class="form-control form-control-sm" value="' . $key->MsWorkplaceCode . '" placeholder="masukan tanggal" readonly>';
                  }
                  ?>
               </div>
            </div>
            <div class="row mb-1 align-items-center">
               ...
               <div class="col-sm-9">
                  <input id="FinancialCategory" name="FinancialCategory" type="text" class="form-control form-control-sm" value="<?= $_finance->FinanceCatName ?>" placeholder="masukan tanggal" readonly>
               </div>
            </div>
            <div class="row mb-1 align-items-center">
               <label for="FinancialDate" class="col-sm-3 col-form-label">Tanggal</label>
               <div class="col-sm-9 ">
                  <input id="FinancialDate" name="FinancialDate" type="text" class="form-control form-control-sm" value="<?= $_finance->FinancialDate ?>" placeholder="masukan tanggal" readonly>
               </div>
            </div>
            <div class="row mb-1 align-items-center">
               <label for="FinancialDesc" class="col-sm-3 col-form-label">Keterangan</label>
               <div class="col-sm-9">
                  <textarea id="FinancialDesc" name="FinancialDesc" type="text" class="form-control form-control-sm" value="" placeholder="Masukan keterangan" readonly><?= $_finance->FinancialDescription ?></textarea>
               </div>
            </div>
            <div class="row mb-1 align-items-center">
               <label for="FinancialTotal" class="col-sm-3 col-form-label">Total</label>
               <div class="col-sm-9">
                  <input id="FinancialTotal" name="FinancialTotal" type="text" class="form-control form-control-sm price-modal" value="<?= number_format($_finance->FinancialTotal) ?>" placeholder="Masukan Total" readonly>
               </div>
            </div>
            <div class="row mb-1 align-items-center">
            </div>
                  ...
                  <div class="border">
                     <div class="dropzone" id="file-upload">
                        <div class="dz-message">
                           <span style="font-size:0.85rem">Tidak ada file yang ditemukan</span><br>
...
<script>
   var path_folder = new Date().getTime();
      ...
      $("form[name='form-action']").validate({
         ...
         submitHandler: function(form) {
            if (!req_status_add) {
               ...
               $.ajax({
                  method: "POST",
                  url: "<?= site_url("function/client_data_financial/data_petty_cash_add") ?>",
                  data: {
                  ...
                  success: function(data) {
                     ...
                     myDropzone.options.url = "<?= site_url("function/client_data_financial/upload_file/") ?>" + path_folder;
