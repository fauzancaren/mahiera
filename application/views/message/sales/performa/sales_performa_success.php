      ...
      <form class="modal-content" name="form-action">
         ...
         <div class="modal-body">
            ...
            <div class="row mb-1 align-items-center">
               ...
               <div class="col-sm-9">
                  <select class="custom-select custom-select-sm form-control form-control-sm select-modal" id="MsMethodId" name="MsMethodId" style="width:100%">
                     ...
                     foreach ($db as $key) {
                        echo '<option value="' . $key->MsMethodId . '" ' . ($_performa->MsMethodId == $key->MsMethodId ? "Selected" : "") . '>' . $key->MsMethodCode . ' - ' . $key->MsMethodName . '</option>';
                     }
                     ?>
                  </select>
               </div>
            ...
            <div class="row mb-1 align-items-center">
               ...
               <div class="col-sm-9">
                  <input id="PaymentCardName" name="PaymentCardName" type="text" class="form-control form-control-sm" value="<?= $_performa->PerformaCardName ?>" placeholder="Masukan Nama ">
               </div>
            </div>
            <div class="row mb-1 align-items-center">
               <label for="PaymentTotal" class="col-sm-3 col-form-label">Total</label>
               <div class="col-sm-9">
                  <input id="PaymentTotal" name="PaymentTotal" type="text" class="form-control form-control-sm price-modal" value="<?= $_performa->PerformaTotal ?>" placeholder="Masukan Total">
               </div>
            </div>
            <div class="row mb-1 align-items-center">
            </div>
...
<script>
   ...
   $("#Paymentfile").hide();
   $("#paymentupload").show();
   var datestart = moment("<?= $_performa->PerformaDate ?>");
   /*  TANGGAL DOKUMENT */
            ...
            if (!req_status_add) {
               ...
               $.ajax({
                  ...
                  data: {
                     ...
                     "PaymentRef": "<?= $_performa->PerformaRef ?>",
