            ...
            <div class="row justify-content-center">
               <div class="col-lg-6 col-11 my-1">
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-9">
                        <input id="DeliveryRit" name="DeliveryRit" type="text" class="form-control form-control-sm" value="<?= $_delivery->DeliveryRit ?>" readonly>
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
...
<script>
   ...
   var detail_delivery = <?= JSON_ENCODE($_detaildelivery) ?>;
   ...
   function get_detail_delivery(itemid, vendor) {
      var total = 0;
      for (var i = 0; detail_delivery.length > i; i++) {
         if (itemid == detail_delivery[i]['MsItemId'] && vendor == detail_delivery[i]['MsVendorCode']) {
            total += parseFloat(detail_delivery[i]['DeliveryDetailQty']);
         }
      }
      return total;
   }
   for (var i = 0; data_item_edit.length > i; i++) {
      ...
      data_item.push([htmlItem,
         ...
         total_pengiriman,
         get_detail_delivery(data_item_edit[i]['MsItemId'], data_item_edit[i]['MsVendorCode']),
      ]);
