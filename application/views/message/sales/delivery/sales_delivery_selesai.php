   ...
   <div class="modal-dialog modal-xl">
      <div class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-share-square" aria-hidden="true" style="color: #6754ff;"></i> &nbsp;Selesaikan Pengiriman - <?= ($_sales->MsCustomerTypeId == 1 ? $_sales->MsCustomerName : $_sales->MsCustomerName . ' (' . $_sales->MsCustomerCompany . ')') ?></h6>
            ...
            <div class="row justify-content-center">
               <div class="col-lg-6 col-11 my-1">
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-3">
                        <input id="DeliveryDateFinish" name="DeliveryDateFinish" type="text" class="form-control form-control-sm" value="">
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
                  </div>
               ...
               <div class="col-lg-6 col-11 my-1">
                  <div class="row mb-1 align-items-center">
                     <div class="label-border-right">
                        <span class="label-dialog">Upload Bukti Penerimaan</span>
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center"> 
                     <div class="col-sm-12">
               ...
               <div class="col-lg-6 col-11 my-1">
                  <div class="row mb-1 align-items-center">
                     <div class="label-border-right">
                        <span class="label-dialog">Tanda Tangan Penerima</span>
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center"> 
                     <div class="col">
...
<script>
   ...
   var datestartkirim = moment("<?= $_delivery->DeliveryDateKirim ?>");
   var datestartfinish = moment();
   ...
   for (var i = 0; data_item_edit.length > i; i++) {
      ...
      data_item.push([htmlItem,
         ...
         total_pengiriman,
         data_item_edit[i]['DeliveryDetailQty'],
         data_item_edit[i]['DeliveryDetailSpareQty'],
      ]);
   }
   ...
   $("#btn-submit").click(async function() {
      ...
      if (!req_status_add) {
         ...
         var dataheader = {
            ...
            "DeliveryDateFinish": moment(datestartfinish).format('YYYY-MM-DD'), 
            ...
            success: function(data) {
               ...
               Swal.fire({
                  ...
                  if (result.dismiss === Swal.DismissReason.timer) {
                     $.ajax({
                        method: "POST",
                        url: "<?= site_url("function/client_data_sales/data_delivery_upload_penerima/") ?>" + <?= $_delivery->DeliveryId ?>,
                        data: {
