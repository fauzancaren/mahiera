   ...
   <div class="modal-dialog modal-xl">
      <div class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-plus text-success" aria-hidden="true"></i> &nbsp;Buat Penjualan Baru (Sales Order) </h6>
   ...
   $("#btn-submit").click(async function() {
      ...
      if (!req_status_add) {
         ...
         var dataheader = {
            ...
            "SalesDate2": moment().format('YYYY-MM-DD'),
            "MsEmpId": $("#MsEmpId").val(),
            "MsWorkplaceId": $("#MsWorkplaceId").val(),
         ...
         var detailoptional = [];
         for (var i = 0; data_optional.length > i; i++) {
            /* data_item (html,MsProdukId,vendorcode,price,qty,disc,uom,total) */
            var data = {
         ...
         $.ajax({
            method: "POST",
            url: "<?= site_url("function/client_data_sales/data_sales_add") ?>",
            data: {
               "data": dataheader,
               "item": detailitem,
