   ...
   <div class="modal-dialog modal-xl">
      <div class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-plus text-success" aria-hidden="true"></i> &nbsp;Kirim barang (TO)</h6>
            ...
            <div class="row justify-content-center">
               <div class="col-lg-6 col-11 my-1">
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-9">
                        <input id="SalesCode" name="SalesCode" type="text" class="form-control form-control-sm" value="<?= $_sales->SalesCode ?>" readonly>
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
...
<script>
   ...
   load_src();
   $('#InvTOSrc').val(<?= $this->session->userdata("MsWorkplaceId") ?>); // Change the value or make some change to the internal state
   ...
   for (var i = 0; data_item_edit.length > i; i++) {
      ...
      arr["InvTODetailQty"] = data_item_edit[i]['SalesDetailQty']; 
   ...
   $("#btn-submit").click(function() {
      ...
      var dataheader = {
         ...
         "InvTODate2": moment().format('YYYY-MM-DD'),
      ...
      $.ajax({
         method: "POST",
         url: "<?= site_url("function/client_data_sales/data_to_add") ?>",
         data: {
            "data": dataheader,
            "item": detailitem,
         },
