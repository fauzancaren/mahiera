   ...
   <div class="modal-dialog modal-xl">
      <div class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-plus text-success" aria-hidden="true"></i> &nbsp;Barang Rusak (IW)</h6>
...
<script>
   ...
   $("#btn-submit").click(function() {
      ...
      var dataheader = {
         ...
         "InvWasteDate2": moment().format('YYYY-MM-DD'),
      ...
      $.ajax({
         method: "POST",
         url: "<?= site_url("function/client_data_inventory/data_waste_add") ?>",
         data: {
            "data": dataheader,
            "item": detailitem,
         },
