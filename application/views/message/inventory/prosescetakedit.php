    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content" name="form-action">
            <div class="modal-header bg-dark">
                <h6 class="modal-title text-white"><i class="fas fa-pencil-alt text-warning" aria-hidden="true"></i> &nbsp;Edit Proses Cetak - <?= $_dataproduksi->MsItemName ?></h6>
...
<script>
    ...
    $("#btn-submit").click(function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?= site_url("function/client_data_inventory/data_produksi_cetak_edit") ?>",
            data: {
            ...
            success: function(data) {
                ...
                if (data) {
                    Swal.fire({
                        icon: 'success',
                        text: 'Edit Proses cetak berhasil',
                        showConfirmButton: false,
                        allowOutsideClick: false,
                        allowEscapeKey: false,
                        timer: 1500,
