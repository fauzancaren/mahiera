   ...
   <div class="modal-dialog modal-xl">
      <div class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-pencil-alt text-warning" aria-hidden="true"></i> &nbsp;Barang Sampel (IS)</h6>
            ...
            <div class="row justify-content-center">
               <div class="col-lg-6 col-11 my-1">
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-9">
                        <input id="TOCode" name="TOCode" type="text" class="form-control form-control-sm" value="<?= $_data->InvSampleCode ?>" readonly>
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-9">
                        <textarea class="form-control form-control-sm" id="TORemarks" name="TORemarks"><?= $_data->InvSampleRemarks ?></textarea>
                     </div>
                  </div>
               </div>
...
<script>
   /*  ARRAY SELECT */
   var datestart = moment("<?= $_data->InvSampleDate ?>");
   ...
   data_item.forEach(data => {
      ...
      htmlItem += '       Qty<span>&nbsp;(' + data.MsItemUoM + ')</span> : <input type="text" class="input-in-table double" name="MsItemBomDetailCount" value="' + data.InvSampleDetailQty + '"/>';
      htmlItem += '   </div>';
      ...
      htmlItem += '       </div>';
      htmlItem += '   </div>';
      table_data.push([counter, htmlItem, data.MsItemId, data.MsVendorCode, data.InvSampleDetailQty]);
      counter++;
   });
   ...
   $.ajax({
      method: "POST",
      dataType: "json",
      url: "<?= site_url("function/client_data_sales/get_max_customer/") . $_data->MsCustomerId ?>",
      success: function(data) {
   ...
   $("#btn-submit").click(function() {
      ...
      $.ajax({
         method: "POST",
         url: "<?= site_url("function/client_data_inventory/data_sample_edit/") . $_data->InvSampleId ?>",
         data: {
            "data": dataheader,
            "item": detailitem,
         },
