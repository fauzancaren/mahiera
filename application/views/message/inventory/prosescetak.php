    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content" name="form-action">
            <div class="modal-header bg-dark">
                <h6 class="modal-title text-white"><i class="fas fa-check text-success" aria-hidden="true"></i> &nbsp;Proses Cetak - <?= $_dataitem->MsItemName ?></h6>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-6 col-11 my-1">
                        ...
                        <div class="row mb-1 align-items-center"> 
                            ...
                            <div class="col-sm-9">
                                <input id="ProduksiQtyRef" name="ProduksiQtyRef" type="text" class="form-control form-control-sm" value="<?= $_dataitem->PODetailQty. " ".$_dataitem->MsItemUoM  ?>" readonly>
                            </div> 
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-11 my-1">
                        ...
                        <div class="row mb-1 align-items-center">
                            ...
                            <div class="col-sm-3">
                                <input id="ProduksiQty" name="ProduksiQty" type="text" class="form-control form-control-sm double" value="<?= $_dataitem->PODetailQty ?>">
                            </div>  
                            <label for="ProduksiQty" class="col-sm-3 col-form-label fw-bold"><?= $_dataitem->MsItemUoM ?></label>
                        </div> 
                    </div>
                    <div class="col-xl-6 col-11 my-1">
                        <div class="row mb-1 align-items-center">
                        ...
                        <div class="row mx-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="checkproduksi" checked>
...
<script>
        ...
        $("#detail-bom").append(`<div class="row mx-2 align-items-center border-bottom border-opacity-10">
                                    ...
                                    <div class='col-6'>
                                        <div class='d-flex flex-column'>
                                            <span class='fw-bold'>` + element["MsItemCode"] +` - ` + element["MsItemName"] +`</span>
                                            <span>` + element["MsItemSize"] +` | ` + element["MsVendorCode"] +`</span>
                                        </div>
                                    </div> 
                                    <div class='col-3'>
                                        <div class='d-flex flex-column'>
                                            <input type='text' class='form-control form-control-sm double bom-detail' value='`+ (($("#ProduksiQty").val()/element["MsItemBomCount"] ) * element["MsItemBomDetailCount"]) +`' data-id="` + element["MsItemId"] +`" data-vendor="` + element["MsVendorCode"] +`" data-std="` + element["MsItemBomDetailCount"] +`" data-head-std="` + element["MsItemBomCount"] +`" disabled>
                                        </div>
                                    </div>
    ...
    $("#btn-submit").click(function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?= site_url("function/client_data_inventory/data_produksi_cetak") ?>",
            data: {
                "data": dataheader, 
                "detail": detailitem, 
            },
