    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content" name="form-action">
            <div class="modal-header bg-dark">
                <h6 class="modal-title text-white"><i class="fas fa-check text-success" aria-hidden="true"></i> &nbsp;Proses Selesai - <?= $_dataproduksi->MsItemName ?></h6>
            ...
            <div class="modal-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-11 my-1">
                        ...
                        <div class="row mb-1 align-items-center">
                            <label for="ProduksiDate" class="col-sm-3 col-form-label">Tanggal Selesai<sup class="error">&nbsp;*</sup></label>
                            <div class="col-sm-9">
...
<script>
    ...
    var datestartkering = moment("<?= $_dataproduksi->ProduksiDateKering ?>"); 
    ...
    $("#btn-submit").click(function() {
        ...
        var dataheader = {
            ...
            "ProduksiDate": moment(datestart).format('YYYY-MM-DD'), 
            "MsEmpId": $("#MsEmpId").val(),
        ...
        $.ajax({
            method: "POST",
            url: "<?= site_url("function/client_data_inventory/data_produksi_ready") ?>",
            data: {
