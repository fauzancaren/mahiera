   ...
   <div class="modal-dialog modal-xl modal-dialog-centered ">
      <form class="modal-content" name="form-action-customer">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-plus text-success" aria-hidden="true"></i> &nbsp;Tambah Data Pelanggan</h5>
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-5 col-5  pe-0">
                        <div class="input-group">
                           ...
                           <button class="btn btn-success btn-sm" id="create-category" type="button"><i class="fas fa-plus" aria-hidden="true"></i></button>
                        </div>
                     </div>
                     <div class="col-sm-5 col-7">
                        <input id="MsCustomerCompany" name="MsCustomerCompany" type="text" class="form-control form-control-sm" value="-" readonly placeholder="isi nama perusahaan">
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
                     <label for="MsCustomerRemarks" class="col-sm-2 col-form-label">Note</label>
                     <div class="col-sm-10">
                        <input id="MsCustomerRemarks" name="MsCustomerRemarks" type="text" class="form-control form-control-sm" value="">
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center mt-2">
                     <label for="MsCustomerCode" class="col-sm-2 col-form-label">Kode<sup class="error">&nbsp;*</sup></label>
                     <div class="col-sm-10">
                        <input id="MsCustomerCode" name="MsCustomerCode" type="text" class="form-control form-control-sm" value="<?= $_code ?>" readonly>
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
                     <label for="MsCustomerName" class="col-sm-2 col-form-label">Nama<sup class="error">&nbsp;*</sup></label>
                     <div class="col-sm-10">
                        <input id="MsCustomerName" name="MsCustomerName" type="text" class="form-control form-control-sm" value="">
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-10 d-flex justify-content-between align-items-center">
                        <input id="MsCustomerTelp1" name="MsCustomerTelp1" type="text" class="form-control form-control-sm input-phone" value="">
                        <span class="fw-bold px-2">/</span>
                        <input id="MsCustomerTelp2" name="MsCustomerTelp2" type="text" class="form-control form-control-sm input-phone" value="">
                     </div> 
                  </div> 
               </div> 
               <div class="col-lg-6 col-11 my-1">
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-10">
                        <input id="MsCustomerEmail" name="MsCustomerEmail" type="text" class="form-control form-control-sm" value="">
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
                     <label for="MsCustomerInstagram" class="col-sm-2 col-form-label">Instagram</label>
                     <div class="col-sm-10">
                        <input id="MsCustomerInstagram" name="MsCustomerInstagram" type="text" class="form-control form-control-sm" value="">
                     </div>
                  </div>
                  <div class="row mb-1 align-items-center">
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col-sm-10">
                        <textarea id="MsCustomerAddress" name="MsCustomerAddress" type="text" class="form-control form-control-sm" value="" placeholder="Nama jalan, gedung, no Rumah" ></textarea>
                     </div>
                  </div> 
               </div> 
                        ...
                        <div id="data-pengiriman" class="d-flex flex-column mt-1">
                           <div class="card shadow-sm card-delivery select">
                              <div class="p-2 ps-4">
                                 ...
                                 <span class="card-text">Jl. Banding V, Kec. Tangerang, Kota Tangerang, Banten, 15118 [Tokopedia Note: aura laundry jalan banding 5 blok d8 no 5]</span><br>
                           ...
                           <div class="card shadow-sm card-delivery">
                              <div class="p-2 ps-4">
...
<script>
   ...
   */
   $(function() {
      ...
      function uploaddata() {
         ...
         if (!req_status) {
            ...
            $.ajax({
               method: "POST",
               url: "<?= site_url("function/client_data_master/data_customer_add/") ?>",
               data: {
                  "MsCustomerIsActive": "on",
   ...
   $("#create-delivery").click(function() {
      ...
      /*
          $("#MsCustomerDeliveryReceive").val("");
          $("#MsCustomerDeliveryTelp").val("");
          $("#MsCustomerDeliveryAddress").val("");
          $("#MsCustomerDeliveryLat").val("");
          $("#MsCustomerDeliveryLng").val("");
      */
      maplocation = {
         lat: -6.265707593132433,
         lng: 106.77526944082672
   ...
   $("#select-map").click(function() {
      ...
      if ($("#MsCustomerDeliveryName").text() != "Tandai lokasi dalam peta untuk memudahkan pengiriman") {
         maplocation = {
            lat: $("#MsCustomerDeliveryLat").val(),
            lng: $("#MsCustomerDeliveryLng").val()
         };
         mapaddress = {
