        ...
        <div class="modal-content" name="form-action">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-11 my-1">
                        <div class="row mb-1 align-items-center">
                            ...
                            <div class="col-sm-8">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="MsProdukStock" value="option1">
                                    <label class="form-check-label col-form-label" for="MsProdukStock">Stock</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="MsProdukSale" value="option1">
                        ...
                        <div class="row mb-1 align-items-center">
                            ...
                            <div class="col-sm-8">
                                <select class="custom-select custom-select-sm form-control form-control-sm" id="MsProdukCatId" name="MsProdukCatId" style="width:100%">
                                <?php
                                foreach ($category as $key) {
                                    echo '<option value="' . $key->MsProdukCatId . '" data-kode="' . $key->MsProdukCatCode . '">' . $key->MsProdukCatCode . ' - ' . $key->MsProdukCatName . '</option>';
                                }
                                ?>
                                </select>
                            </div>
                        ...
                        <div class="row mb-1 align-items-center">
                            ...
                            <div class="col-sm-8">
                                <input id="MsProdukCode" name="MsProdukCode" type="text" class="form-control form-control-sm" value="" readonly>
                            </div>
                        </div>
                        <div class="row mb-1 align-items-center">
                            <label for="MsProdukName" class="col-sm-4 col-form-label">Nama<sup class="error">&nbsp;*</sup></label>
                            <div class="col-sm-8">
                                <input id="MsProdukName" name="MsProdukName" type="text" class="form-control form-control-sm" value="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-11 my-1"> 
                        <label for="MsProdukDesc" class="col-sm-4 col-form-label">Detail Produk<sup class="error">&nbsp;*</sup></label> 
                        <textarea id="MsProdukDesc" name="MsProdukDesc" type="text" class="form-control form-control-sm" rows="5"></textarea> 
                    </div> 
                </div>
            ...
            <div class="modal-footer">
                <div class="flex-grow-1" style="color: gray;font-size:12px;">
                    ...
                    <span>2 . Menghapus Varian akan berpengaruh pada stock yang sudah terbuat</span><br>
...
<script>  
    ...
    // Insert data langsung ke select2
    ...
    arr["varian"] = "Vendor";
    arr["value"] = [];
    // arr["value"] = [{id: '2', text: 'PSL', html: '<span class="fw-bold">PSL - PAK SLAMET</span>', selected: true}]; //fungsi untuk insert ke select2
    ...
    load_data_varian = function(){
        ...
        $(".selectvarianvalue").on("select2:selecting", function(e) {  
    ...
    get_arr_val_old = function(key,param){
        var value = 0; 
        for(var i = 0; i< data_varians.length;i++){
            var truedata = 0;
            $.each(data_varians[i]["varian"], function(key1, value1) { 
            ...
            if(data_varians[i]["varian"].length == truedata){
                value = data_varians[i][param];
            } 
        }
        return value;
    } 
    ...
    $("#btn-submit").click(function(){
        ...
        $.ajax({
            method: "POST", 
            url: "<?= site_url("function/client_data_master/data_item_add") ?>",
            data: {
                "header": data_header,
                "detail": data_detail,  
                "image":data_image,
