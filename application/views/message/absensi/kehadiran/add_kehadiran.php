<div class="modal fade " id="modal-action" data-bs-keyboard="false" data-bs-backdrop="static">
   <div class="modal-dialog modal-dialog-centered ">
      <div class="modal-content" name="create-toko">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-plus text-success" aria-hidden="true"></i> &nbsp;Tambah kelola kehadiran</h5>
         ...
         <div class="modal-body">
               ...
               <div class="col-sm-9">
                  <select class="custom-select custom-select-sm form-select form-select-sm" id="AbsenKelolaType" name="AbsenKelolaType" style="width:100%">
                     ...
                     foreach ($_kelola as $row) {
                        echo "<option value='" . $row->AbsenKelolaTypeId . "'  data-name='" . $row->AbsenKelolaTypeName . "' >" . $row->AbsenKelolaTypeName .  "</option>";
                     }
                     ?>
                  </select>
               </div>
            ...
            <div class="row mb-1">
               ...
               <div class="col-sm-9">
                  <input type="text" id="AbsenNote" name="AbsenNote" class="form-control form-control-sm" value="">
               </div>
            </div>
         </div>
   ...
   <script>
      ...
      $("#btn-submit").click(function() {
         $.ajax({
            method: "POST",
            url: "<?= site_url("function/client_data_absen/kehadiran_add") ?>",
            data: {
