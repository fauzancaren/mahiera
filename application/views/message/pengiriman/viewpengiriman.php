   ...
   <div class="modal-dialog modal-xl">
      <div class="modal-content" name="form-action">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-eye text-primary" aria-hidden="true"></i> &nbsp;View Pengiriman</h6>
            ...
            <div class="row justify-content-center">
               ...
               <div class="col-lg-6 col-11 my-1">
                  ...
                  <div class="row mb-1 align-items-center">
                     <div class="col-8">
                        <div class="row align-items-center">
                           ...
                           <div class="col">
                              <input id="DeliveryDate" name="DeliveryDate" type="text" class="form-control form-control-sm" value="" readonly>
                           </div>
                        </div>
                     </div>
                     <div class="col-4">
                  ...
                  <div class="row mb-1 align-items-center">
                        ...
                        <div class="row align-items-center">
                           ...
                           <div class="col">
                              <div class="input-group">
                                 <select class="custom-select custom-select-sm form-control form-control-sm" id="MsDeliveryId" name="MsDeliveryId" disabled>
                                    <?php
                     ...
                     <div class="col-4">
                        <div class="row mb-1 align-items-center MsEmpId">
                           ...
                           <div class="col">
                              <select class="custom-select custom-select-sm form-control form-control-sm" id="DeliveryJenis" name="DeliveryJenis" readonly>
                  ...
                  <div class="row mb-1 align-items-center MsEmpId">
                     ...
                     <div class="col">
                        <select class="custom-select custom-select-sm form-control form-control-sm select-modal" id="MsEmpId" name="MsEmpId" style="width:100%" multiple="multiple" required readonly>
                           <?php
                  ...
                  <div class="row mb-1 align-items-center">
                     ...
                     <div class="col">
                        <textarea class="form-control form-control-sm" id="PORemarks" name="PORemarks" readonly></textarea>
                     </div>
                  </div>
               </div>
