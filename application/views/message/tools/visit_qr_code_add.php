   ...
   <div class="modal-dialog modal-dialog-scrollable modal-xl">
      <div class="modal-content">
         <div class="modal-header bg-dark">
            <h6 class="modal-title text-white"><i class="fas fa-plus text-success" aria-hidden="true"></i> &nbsp;Tambah QR Code</h6>
                     ...
                     <div class="accordion-item mt-2">
                        ...
                        <div id="panel-design-customizations" class="accordion-collapse collapse show" aria-labelledby="panelstay-design-customizations">
                           <div class="accordion-body">
                              <div class="mb-1">
                                 <label for="formFileSm" class="form-label">Upload image for heading</label>
                        ...
                        <div id="panel-basic-information" class="accordion-collapse collapse show" aria-labelledby="panelstay-basic-information">
                           <div class="accordion-body">
                              <div class="row mb-4">
                                 ...
                                 <div class="col-8">
                                    <input class="form-control form-control-sm" id="qrCodeHeadline" value="Connect with us on social media" type="text">
                                 </div>
                              </div>
                              <div class="row mb-3">
                                 <div class="col-4">
                                 ...
                                 <div class="col-8">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="qrCodeAboutUs">Follow us and get updates delivered to your favorite social media channel.</textarea>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="position-absolute">
                     <div class="live-preview-outline">
                        <div class="live-preview" style="overflow: auto; overflow-x: hidden;">
                           <div class="row">
                              <img id="image-preview" style=" border: none; padding: 0; height: 150px;">
                              </img>
