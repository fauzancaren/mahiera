    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h6 class="modal-title text-white"><i class="fas fa-plus text-success" aria-hidden="true"></i> &nbsp;Tambah Device Property</h6>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="AssetDetailMerk" value="" placeholder="Masukan Merk Device...">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" name="AssetDetailType" id="AssetDetailType" placeholder="Masukan Type Device" value=""></input>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="AssetDetailUser" value="" placeholder="Masukan Nama Pengguna...">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <select class="form-select form-select-sm" id="MsWorkplaceId" aria-label=".form-select-sm example">
                            ...
                            foreach ($query->result() as $row) {
                                echo "<option value='$row->MsWorkplaceId'>$row->MsWorkplaceCode</option>";
                            }
                            ?>
                        </select>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control form-control-sm" id="AssetDetailDeskripsi" placeholder="Masukan Nama Pengguna..."></textarea>
                    </div>
                </div>
...
<script>
    $('#btn-submit').click(function() {
        ...
        var divisiAsset = $("#assetDivisiId").val();
        var device = $("#AssetId").val();
        var merkDevice = $("#AssetDetailMerk").val();
        var type = $("#AssetDetailType").val();
        var user = $("#AssetDetailUser").val();
        var grai = $("#MsWorkplaceId").val();
        var status = $("#AssetDetailStatus").val();
        var deskripsi = $("#AssetDetailDeskripsi").val();
        $.ajax({
            method: "POST",
            url: "<?= site_url("function/client_data_tools/assetAdd") ?>",
            data: {
                divisiAsset: divisiAsset,
                device: device,
                merkDevice: merkDevice,
                user: user,
                grai: grai,
                status: status,
                type: type,
