...
! function (t, e) {
   ...
   var G = {
      ...
      setTransform: function (t, e, n) {
         var o = e.x,
            ...
            a = e.scale,
            e = e.isSVG;
         B(t, "transform", "scale(" + a + ") translate(" + o + "px, " + r + "px)"), e && i && (e = window.getComputedStyle(t).getPropertyValue("transform"), t.setAttribute("transform", e))
      },
      startX: 0,
      startY: 0,
      startScale: 1,
   ...
   function t(d, f) {
      ...
      var t;
      f = C(C({}, G), f);
      var e, c = (e = d, F.test(e.namespaceURI) && "svg" !== e.nodeName.toLowerCase()),
         n = d.parentNode;
      n.style.overflow = f.overflow, n.style.userSelect = "none", n.style.touchAction = f.touchAction, (f.canvas ? n : d).style.cursor = f.cursor, d.style.userSelect = "none", d.style.touchAction = f.touchAction, B(d, "transformOrigin", "string" == typeof f.origin ? f.origin : c ? "0 0" : "50% 50%");
      var o, r, a, i, l, s, m = 0,
         h = 0,
         v = 1,
         p = !1;
      ...
      function g(t, e, n) {
         ...
         return requestAnimationFrame(function () {
            var t;
            "boolean" == typeof e.animate && (e.animate ? (t = e, B(d, "transition", q("transform") + " " + t.duration + "ms " + t.easing)) : B(d, "transition", "none")), e.setTransform(d, o, e)
         }), u(t, o, e), u("panzoomchange", o, e), o
      }

      function y() {
         var t, e, n;
         f.contain && (e = (n = D(d)).parent.width - n.parent.border.left - n.parent.border.right, t = n.parent.height - n.parent.border.top - n.parent.border.bottom, e = e / (n.elem.width / v), n = t / (n.elem.height / v), "inside" === f.contain ? f.maxScale = Math.min(e, n) : "outside" === f.contain && (f.minScale = Math.max(e, n)))
      }
      ...
      function P(t) {
         ! function (t, e) {
            ...
            isSVG: c,
            originalEvent: t
         }, f), t = L(M), a = t.clientX, i = t.clientY, l = v, s = I(M))
      }

      function A(t) {
         var e;
         p && void 0 !== o && void 0 !== r && void 0 !== a && void 0 !== i && (N(M, t), e = L(M), 1 < M.length ? (0 === s && (s = I(M)), O(b((I(M) - s) * f.step / 80 + l).scale, e)) : x(o + (e.clientX - a) / v, r + (e.clientY - i) / v, {
            animate: !1
         }, t))
      }
      ...
      function Y() {
         X || (X = !0, W("down", f.canvas ? n : d, P), W("move", document, A, {
            passive: !0
         }), W("up", document, z, {
            passive: !0
         }))
      ...
      return f.noBind || Y(), {
         bind: Y,
         destroy: function () {
            X = !1, Z("down", f.canvas ? n : d, P), Z("move", document, A), Z("up", document, z)
         },
         eventNames: V,
         getPan: function () {
            return {
         ...
         resetStyle: function () {
            n.style.overflow = "", n.style.userSelect = "", n.style.touchAction = "", n.style.cursor = "", d.style.cursor = "", d.style.userSelect = "", d.style.touchAction = "", B(d, "transformOrigin", "")
         },
